...
if(isset($_GET["id"])){
	...
	$sql="UPDATE `newlist` SET `registrationdate`=?,`title`=?,`content`=?,`author`=?,`active`=?,`image`=? WHERE id=?";
	$stmt = $conn->prepare($sql);
	$stmt->execute([ $registrationdate, $title , $content , $author , $active , $image_name , $id]);
									...
									<form   method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="News-date" required="required"name="registrationdate" class="form-control "   value="<?php echo $registrationdate?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="title" required="required" name="title" class="form-control "   value="<?php echo $title ?>">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox"  name="active"  <?php echo $activated ?> class="flat">
												</label>
											</div>
										</div>
										<div class="item form-group">
