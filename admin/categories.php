               ...
               $id=$result["id"];
                 ?>
                        <tr>
                          ...
                          <td><a href="editcategory.php?id=<?php echo $id ?>"><img src="images/edit.png" alt=""></a></td>
               <td><a href="delete.php?id=<?php echo $id ?>" onclick="return confirm('Are you sure you want to delete?')"><img src="images/delete.png" alt=""></a></td>
                        </tr>
