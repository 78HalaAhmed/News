...
if($_SERVER["REQUEST_METHOD"]==="POST"){
	...
	if($category>0){
    try{
        $sql="INSERT INTO `newlist`( `registrationdate`, `title`, `content`, `Author`,`active`, `image`) VALUES (?,?,?,?,?,?)";
        ...
        $stmt->execute([$registrationdate,$title,$content,$Author,$active,$image_name]);
									...
									<form    method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  enctype="multipart/form-data" >
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date" name="registrationdate" id="News-date" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="category" id="">
													...
													<?php
                                                   foreach($stmtnew->fetchAll() as $row){
